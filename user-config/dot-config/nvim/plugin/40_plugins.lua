...
on_filetype('markdown', function()
  ...
  add({ 'https://github.com/iamcco/markdown-preview.nvim', 'https://github.com/TobinPalmer/pastify.nvim' })
  ...
  require('pastify').setup {
    opts = {
      ...
      filename = function() return vim.fn.expand("%:t:r") .. '_' .. os.date("%Y-%m-%d_%H-%M-%S") end, -- The file name to save the image as, if empty pastify will ask for a name
