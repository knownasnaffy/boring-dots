...
nmap_leader('h', '^', 'Move to the first non-blank character')
...
nmap_leader('bo', '<Cmd>%bd|e#|bd#<CR>',                         'Delete Others')
...
nmap_leader('fe', pick_git_status,                              'Git changes')
...
nmap_leader('oh', '<Cmd>Himalaya<CR>',                     'Open Himalaya')
